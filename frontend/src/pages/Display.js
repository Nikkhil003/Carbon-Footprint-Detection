      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-300">
          <div className="bg-gradient-to-r from-blue-300 to-teal-300 text-white py-8">
            <h1 className="text-5xl font-bold text-center">Carbon FootPrint Detection Project Calculations</h1>
            <p className="text-lg text-center mt-2 font-medium">
              An in-depth look at the calculations used in the Carbon FootPrint Detection project, detailing emissions and neutralization pathways.
            </p>
          </div>
